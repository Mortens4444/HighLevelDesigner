namespace Mtf.Core
{
	partial class ThreeOptionConfirmBox
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ThreeOptionConfirmBox));
			...
			this.p_Main.Controls.Add(this.btn_No);
			this.p_Main.Controls.Add(this.btn_Cancel);
			this.p_Main.Controls.Add(this.btn_Yes);
			...
			this.btn_No.Location = new System.Drawing.Point(165, 76);
			...
			this.btn_Cancel.Location = new System.Drawing.Point(246, 76);
			...
			this.btn_Yes.Location = new System.Drawing.Point(84, 76);
			...
			this.Name = "ThreeOptionConfirmBox";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.Text = "ConfirmBox";
			this.Shown += new System.EventHandler(this.ThreeOptionConfirmBox_Shown);
